...
import { getAll } from './story';
import { images, loadMore } from  './gallery';
export const LOGIN_LOADING = 'LOGIN_LOADING';
export const LOGIN_SUCCESS = 'LOGIN_SUCCESS';
export const LOGIN_FAILURE = 'LOGIN_FAILURE';
export const STORY_ALL = 'STORY_ALL';
export const IMAGE_ALL = 'IMAGE_ALL';
export const IMAGE_MORE = 'IMAGE_MORE';

// export const getAllImages = images;
// export const getAllStories = getAll;
// export const getAll;
// export const story;
